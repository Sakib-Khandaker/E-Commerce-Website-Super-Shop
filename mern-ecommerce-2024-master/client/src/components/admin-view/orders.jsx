...
function AdminOrdersView() {
  ...
  return (
    <Card className="bg-gray-800 text-white rounded-lg shadow-lg">
      <CardHeader className="bg-gray-900 p-4 rounded-t-lg">
          ...
          <TableBody>
            {orderList && orderList.length > 0
              ? orderList.map((orderItem) => (
                  <TableRow key={orderItem._id} className="hover:bg-gray-700 transition-all duration-300">
                    <TableCell className="text-sm">{orderItem?._id}</TableCell>
                    <TableCell className="text-sm">{orderItem?.orderDate.split("T")[0]}</TableCell>
                    <TableCell>
                      <Badge
                    ...
                    <TableCell className="text-sm">BDT {orderItem?.totalAmount}</TableCell>
                    <TableCell>
                      <Dialog
